...
public class Vgg16TransferLearn {
    // Logging config
    private static Logger log = LoggerFactory.getLogger(Vgg16TransferLearn.class);
    private static final String[] allowedExtensions = BaseImageLoader.ALLOWED_FORMATS;
    private static final int labelIndex = 1;

    public static void main(String[] args) throws IOException {
        log.info("Vgg16 Transfer Learning Dogs and Cats Example");
        ...
        ComputationGraph transferModel = Vgg16TransferNetFactory.buildNetwork(numClasses, cliArgs.randomSeed);
